...
// License: Apache-2.0
// Adapted for Navel Trjectory and by Maximilian Pomplun
//
// Modifications for ROS2 Jazzy compatibility:
// - Added std::function<bool()> cancel_checker parameter to createPlan() (API change)
// - Added cancellation check in main planning loop (line ~209)
// - Changed loop variable from int to size_t in findVerticesInsideCircle() (line 91)
#include <cmath>
#include <string>
#include <memory>
