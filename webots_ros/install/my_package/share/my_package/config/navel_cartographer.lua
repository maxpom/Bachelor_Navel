...
-- Pioneer 3-DX tuning for Webots
...
POSE_GRAPH.optimize_every_n_nodes = 35--20
...
POSE_GRAPH.optimization_problem.odometry_translation_weight = 1e3 --less trust in odom
POSE_GRAPH.optimization_problem.odometry_rotation_weight = 1e3 --same
